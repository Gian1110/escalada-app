  ...
  return (
    <Routes>
      <Route element={<Layout />}>
        ...
        <Route path="/admin/nueva" element={
          <ProtectedRoute><AdminNuevaVia /></ProtectedRoute>
        } />
        <Route path="/admin/gestionar" element={
          <ProtectedRoute><AdminGestionar /></ProtectedRoute>
        } />
      </Route>
    </Routes>
  )
