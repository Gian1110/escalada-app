  ...
  return (
    <Page>
      ...
      <div style={{ fontSize: '12px', color: 'var(--chalk-muted)', marginBottom: '1rem', display: 'flex', gap: '6px' }}>
        <span style={{ cursor: 'pointer', color: 'var(--chalk-muted)' }} onClick={() => navigate('/rutas')}>Rutas</span>
        <span>›</span>
      ...
      <div style={{ background: 'var(--rock-card)', border: '1px solid var(--rock-border)', borderRadius: 'var(--rlg)', padding: '1.75rem', marginBottom: '1.5rem' }}>
        <div style={{ fontSize: '10px', color: 'var(--accent)', textTransform: 'uppercase', letterSpacing: '0.12em', marginBottom: '4px' }}>{lugar.zona}</div>
        ...
        <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
          {lugar.altitud && <InfoChip label="Altitud">{lugar.altitud}</InfoChip>}
          {lugar.maps_url && (
